...
<html>
    <head>
        ...
        <body>
            <FONT COLOR="red"><h1>LISTADO DE PRODUCTOS</h1></font>
            ...
            <table border="1" cellpadding="0" cellspacing="0">
                ...
                <td><a href="MainController?opcion=eliminar&id=<%=i.getId() %>" onclick="return confirm('Esta seguro que desea eliminar el registro?');">¿Eliminar Registro?</a> </td>
                </tr>
                <%
                }
                }
